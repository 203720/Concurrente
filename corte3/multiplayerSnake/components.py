...
class Snake():
	...
	def draw(self,win):
		pygame.draw.rect(win,self.color,self.rect,)
		if self.heading == 'U':
			pygame.draw.rect(win,green_lime,(self.rect[0]+2,self.rect[1]+2,2,2))
			pygame.draw.rect(win,green_lime,(self.rect[0]+6,self.rect[1]+2,2,2))
		elif self.heading == 'R':
			pygame.draw.rect(win,green_lime,(self.rect[0]+6,self.rect[1]+2,2,2))
			pygame.draw.rect(win,green_lime,(self.rect[0]+6,self.rect[1]+6,2,2))
		elif self.heading == 'D':
			pygame.draw.rect(win,green_lime,(self.rect[0]+2,self.rect[1]+6,2,2))
			pygame.draw.rect(win,green_lime,(self.rect[0]+6,self.rect[1]+6,2,2))
		else:
			pygame.draw.rect(win,green_lime,(self.rect[0]+2,self.rect[1]+2,2,2))
			pygame.draw.rect(win,green_lime,(self.rect[0]+2,self.rect[1]+6,2,2))
...
class Text():
	def __init__(self, text, color, size, y_shift):
		...
		self.font = pygame.font.Font("Font/ARCADE_N.TTF", self.size)
